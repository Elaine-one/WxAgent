...
| `connectMcpServer` | POST | `/mcp/connect` | 连接 MCP 服务器 |
| `disconnectMcpServer` | POST | `/mcp/disconnect` | 断开 MCP 服务器 |
| `toggleMcp` | POST | `/mcp/toggle` | 启停 MCP 服务 |
| `getFeishuStatus` | GET | `/feishu/status` | 获取飞书连接状态 |
| `testFeishuConnection` | POST | `/feishu/test` | 测试飞书连接 |
| `getFeishuDocuments` | GET | `/feishu/documents` | 获取飞书文档列表 |
| `getFeishuBitables` | GET | `/feishu/bitables` | 获取飞书多维表格 |
| `deleteFeishuDocument` | DELETE | `/feishu/document` | 删除飞书文档 |
